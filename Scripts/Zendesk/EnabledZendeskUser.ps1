...
Invoke-WebRequest -Uri ("https://{subdomain}.zendesk.com/api/v2/users/" + $id + ".json" | echo) -body '{"user": {"suspended": false}}' -ContentType "application/json" -Headers $headers -Method PUT